...
if __name__ == "__main__":
	...
	executor.submit(run_simulation, MatrixGraph, 1000)
	executor.submit(run_simulation, MatrixGraph, 10000)
	executor.submit(run_simulation, MatrixGraph, 100000)
	executor.submit(run_simulation, MatrixGraph, 1000000)

	executor.submit(run_simulation, DictGraph, 1000)
	executor.submit(run_simulation, DictGraph, 10000)
	executor.submit(run_simulation, DictGraph, 100000)
	executor.submit(run_simulation, DictGraph, 1000000)

	executor.submit(run_simulation, DoubleDictGraph, 1000)
	executor.submit(run_simulation, DoubleDictGraph, 10000)
	executor.submit(run_simulation, DoubleDictGraph, 100000)
	executor.submit(run_simulation, DoubleDictGraph, 1000000)

	# start_time = time.time()
	# n = 1000
	# matrix_graph = init_random_graph(MatrixGraph, n, n * 10)
	# run(matrix_graph)
	...
	# run(matrix_graph)
	# print_result("DictGraph", n, start_time)
	#
	# start_time = time.time()
	# n = 10000
	# matrix_graph = init_random_graph(DictGraph, n, n * 10)
	...
	# start_time = time.time()
	# n = 1000
	# matrix_graph = init_random_graph(DoubleDictGraph, n, n * 10)
	# run(matrix_graph)
	# print_result("DoubleDictGraph", n, start_time)
	#
	# start_time = time.time()
	# n = 10000
	# matrix_graph = init_random_graph(DoubleDictGraph, n, n * 10)
