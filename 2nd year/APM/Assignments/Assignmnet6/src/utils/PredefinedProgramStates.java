...
public class PredefinedProgramStates {
    ...
    public static ProgramState PROGRAM_10;
    ...
    public static final String VISUAL_PROGRAM_10 = new CodeFormatter("number v;", 0)
    ...
    static {
        try {
            ...
            PROGRAM_10 = new ProgramState(new CompoundStatement(
                    new DeclarationStatement("v", new NumberType()),
