...
public class GreaterBinaryExpression extends BinaryExpression {

    public GreaterBinaryExpression(ExpressionInterface leftExpression, ExpressionInterface rightExpression) {
