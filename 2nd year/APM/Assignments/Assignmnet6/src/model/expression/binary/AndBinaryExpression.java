...
public class AndBinaryExpression extends BinaryExpression {

    public AndBinaryExpression(ExpressionInterface leftExpression, ExpressionInterface rightExpression) {
