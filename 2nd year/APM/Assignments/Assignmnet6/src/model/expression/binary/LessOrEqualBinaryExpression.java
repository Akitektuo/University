...
public class LessOrEqualBinaryExpression extends BinaryExpression {

    public LessOrEqualBinaryExpression(ExpressionInterface leftExpression, ExpressionInterface rightExpression) {
