...
public class PredefinedProgramStates {
    public static final ListInterface<String> VISUAL_PROGRAMS = new List<>(
            // 1.
            new CodeFormatter("reference<number> v1;")
                    .addLine("reference<number> v2;")
                    .addLine("reference<number> v3;")
                    .addLine("number cnt;")
                    .newLine()
                    .addLine("new(v1, 2);")
                    .addLine("new(v2, 3);")
                    .addLine("new(v3, 4);")
                    .addLine("newLatch(cnt, readHeap(v2));")
                    .newLine()
                    .addLine("fork {")
                    .addLine("writeHeap(v1, readHeap(v1) * 10);", 2)
                    .addLine("print(readHeap(v1));", 2)
                    .addLine("countDown(cnt);", 2)
                    .newLine()
                    .addLine("fork {", 2)
                    .addLine("writeHeap(v2, readHeap(v2) * 10);", 3)
                    .addLine("print(readHeap(v2));", 3)
                    .addLine("countDown(cnt);", 3)
                    .newLine()
                    .addLine("fork {", 3)
                    .addLine("writeHeap(v3, readHeap(v3) * 10);", 4)
                    .addLine("print(readHeap(v3));", 4)
                    .addLine("countDown(cnt);", 4)
                    .addLine("}", 3)
                    .addLine("}", 2)
                    .addLine("}")
                    .newLine()
    ...
    public static ListInterface<ProgramState> PROGRAMS = new List<>(
            ...
            new ProgramState(new CompoundStatement(
                    new DeclarationStatement("v1", new ReferenceType(new NumberType())),
                    new DeclarationStatement("v2", new ReferenceType(new NumberType())),
                    new DeclarationStatement("v3", new ReferenceType(new NumberType())),
                    new DeclarationStatement("cnt", new NumberType()),
                    ...
                    new ForkStatement(new CompoundStatement(
                            new WriteHeapStatement("v1", new MultiplyBinaryExpression(
                            ...
                            new ForkStatement(new CompoundStatement(
                                    new WriteHeapStatement("v2", new MultiplyBinaryExpression(
                                    ...
                                    new ForkStatement(new CompoundStatement(
                                            new WriteHeapStatement("v3", new MultiplyBinaryExpression(
